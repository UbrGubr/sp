<?php
	...
	$readingTaken = $_REQUEST[READINGTAKEN];
	$finalReadingDate = $_REQUEST[FINALREADINGDATE];
	$sid = $_REQUEST[SID];
	
/*	$mathTaken = $_REQUEST[MATHTAKEN];
	$finalMathDate = $_REQUEST[FINALMATHDATE];
...
*/
	...
	//build query string
	$qry="UPDATE assessment SET readComplete =".$readingTaken.", readCompleteDate='".$finalReadingDate."' WHERE sid=".$sid.";";
